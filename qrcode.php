...
<body>
	<?php
	$imgname = "qr.png";
	$data = isset($_GET['data']) ? $_GET['data'] : "https://beitkabir.com/info/";
	...
	QRcode::png($data, $imgname, QR_ECLEVEL_M, 30, 0, true);
	...
	if ($logo !== FALSE) {
		...
		//imagecopyresampled($out, $logopng,  $QR_width - 230, $QR_height - 230, 0, 0, 230, 230, $newwidth, $newheight);
	}
